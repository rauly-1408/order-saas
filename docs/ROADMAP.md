...
Menú online:      ✅ /pedir/estafeten funcional (diseño mobile-first rediseñado)
Checkout:         ✅ Completado Sprint 1
Panel admin:      ✅ Completado Sprint 1
Editor de menú:   ⏳ Pendiente Sprint 2
Resumen diario:   ⏳ Pendiente Sprint 2
...
### Sprint 1 — El ciclo mínimo viable ✅ COMPLETADO

**Objetivo:** Que un cliente pueda hacer un pedido y el dueño pueda verlo y gestionarlo.  
**Duración:** 2 semanas | **Fecha inicio:** 2026-05-20 | **Fecha cierre:** 2026-05-21  
...
- **Speed to value:** El restaurante hace su primer pedido en < 15 minutos desde el registro
- **Mobile-first:** El 80% de los pedidos vienen de móvil — diseñamos ahí primero
- **One-tap actions:** Las acciones más frecuentes (agotado, cambio de estado) con el mínimo de pasos
- **Datos con narrativa:** No mostramos números solos — siempre con contexto y acción sugerida
- **Sin lock-in:** Exportación de datos siempre disponible
...
| 2026-05-21 | Server Component con Prisma directo (fix) | Self-fetch desde Server Components falla en Vercel serverless; llamada directa a Prisma es más eficiente |
