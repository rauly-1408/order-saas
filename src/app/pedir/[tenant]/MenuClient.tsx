        ...
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3">
          <div className="min-w-0">
            ...
            <div className="truncate font-semibold">
              {count} {count === 1 ? "articulo" : "articulos"} - {euros(subtotal)}
            </div>
          </div>
          <div className="flex items-center gap-2">
            {items.length > 0 ? (
              <>
                <button className="rounded-lg border border-zinc-300 px-3 py-2 text-sm font-medium hover:bg-zinc-50" onClick={clear}>
                  Vaciar
                </button>
              ...
              <span className="text-sm text-zinc-400">Vacio</span>
            )}
          </div>
        </div>
      </div>
